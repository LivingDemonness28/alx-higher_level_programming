...
<table>
    <tr>
        <td><h2><a href="https://github.com/LivingDemonness28/alx-higher_level_programming/tree/main/0x00-python-hello_world" target="_blanket">0x00-python-hello_world</a></h2></td>
        <td>
            <ul>
                ...
                <li>Whar is the Zen of Python</li>
    ...
    <tr>
        <td><h2><a href="https://github.com/LivingDemonness28/alx-higher_level_programming/tree/main/0x01-python-if_else_loops_functions" target="_blanket">0x01-python-if_else_loops_functions</a></h2></td>
        <td>
            <ul>
    ...
    <tr>
        <td><h2><a href="https://github.com/LivingDemonness28/alx-higher_level_programming/tree/main/0x02-python-import_modules" target="_blanket">0x02-python-import_modules</a></h2></td>
        <td>
            <ul>
